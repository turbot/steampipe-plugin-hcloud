...
func tableHcloudImage(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			// Other columns
			{Name: "bound_to", Type: proto.ColumnType_INT, Transform: transform.FromField("BoundTo.ID"), Description: "ID of Server the Image is bound to. Only set for Images of type backup."},			
